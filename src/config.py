...
# -- Weather Underground (fuente de resolución de Polymarket) --
_weather_wu = _weather.get("wunderground", {})
WEATHER_WU_ENABLED = _weather_wu.get("enabled", False)
WEATHER_WU_REFRESH_SEC = _weather_wu.get("refresh_sec", 300)
WEATHER_WU_MIN_HOUR = _weather_wu.get("min_hour", 15)
WEATHER_WU_HIGH_CONF_HOUR = _weather_wu.get("high_confidence_hour", 17)
WEATHER_WU_MIN_EDGE = _weather_wu.get("min_edge_pct", 3.0)
WEATHER_WU_MAX_POLY_ODDS = _weather_wu.get("max_poly_odds", 0.92)
WU_API_KEY = os.getenv("WU_API_KEY", _weather_wu.get("api_key", ""))
...
def restore_from_db(saved: dict):
    ...
    cfg.WEATHER_WU_ENABLED = _bool("weather_wu_enabled", cfg.WEATHER_WU_ENABLED)
    cfg.WEATHER_WU_REFRESH_SEC = _int("weather_wu_refresh_sec", cfg.WEATHER_WU_REFRESH_SEC)
    cfg.WEATHER_WU_MIN_HOUR = _int("weather_wu_min_hour", cfg.WEATHER_WU_MIN_HOUR)
    cfg.WEATHER_WU_HIGH_CONF_HOUR = _int("weather_wu_high_conf_hour", cfg.WEATHER_WU_HIGH_CONF_HOUR)
    cfg.WEATHER_WU_MIN_EDGE = _float("weather_wu_min_edge", cfg.WEATHER_WU_MIN_EDGE)
    cfg.WEATHER_WU_MAX_POLY_ODDS = _float("weather_wu_max_poly_odds", cfg.WEATHER_WU_MAX_POLY_ODDS)
